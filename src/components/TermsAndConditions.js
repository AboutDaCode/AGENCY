...
const TermsAndConditions = () => (
  <div>
    ...
    <p>
      Al utilizar el sitio web de Suarez Santana Javier Acoray, usted acepta cumplir con los siguientes términos y condiciones. Si no está de acuerdo con alguno de estos términos, no debe utilizar este sitio.
    </p>

    <h3>1. Uso del Servicio</h3>
    <p>
      Usted se compromete a utilizar nuestros servicios solo para fines legales y conforme a todas las leyes aplicables. No debe utilizar el sitio para actividades fraudulentas o ilegales.
    </p>

    <h3>2. Reservas</h3>
    <p>
      Todas las reservas están sujetas a disponibilidad y confirmación. Nos reservamos el derecho a cancelar reservas en caso de errores en la disponibilidad o precios.
    </p>
