...
const CookiePolicy = () => (
  <div>
    ...
    <p>Este sitio web utiliza cookies para mejorar la experiencia del usuario. Al utilizar nuestro sitio, usted acepta el uso de cookies.</p>
    ...
    <ul>
      ...
      <li>Analizar el tráfico del sitio y el comportamiento de los usuarios</li>
